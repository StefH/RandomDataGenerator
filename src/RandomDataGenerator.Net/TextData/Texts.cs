...
namespace RandomDataGenerator.Net.TextData
{
    public sealed class Texts
    {
        ...
        {
            return typeof(Texts).GetTypeInfo().Assembly.GetManifestResourceStream($"RandomDataGenerator.Net.TextData.{resourceName}.txt");
        }
